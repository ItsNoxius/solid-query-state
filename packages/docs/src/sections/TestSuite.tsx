    ...
    return (
        <Section title="Test suite">
            <p class="text-zinc-400">
                ...
                <code class="rounded bg-zinc-800 px-1.5 py-0.5">SolidTestingAdapter</code> to test
                your components in isolation.
            </p>

            <h3 class="text-lg font-semibold text-white">Running tests</h3>
            <p class="text-zinc-400">From the project root, run the test suite:</p>
            <CodeBlock code="pnpm test:run" language="bash" />

            <h3 class="text-lg font-semibold text-white">Test adapter</h3>
            <p class="text-zinc-400">
                Use <code class="rounded bg-zinc-800 px-1.5 py-0.5">withSolidTestingAdapter</code>{" "}
                to wrap your tests and control the URL in isolation:
            </p>
            <CodeBlock
