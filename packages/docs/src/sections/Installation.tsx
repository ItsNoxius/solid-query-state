    ...
    return (
        <Section title="Installation">
            <p class="text-zinc-400">
                Install the <code class="rounded bg-zinc-800 px-1.5 py-0.5">solid-query-state</code>{" "}
            ...
            <ul class="list-inside list-disc space-y-2 text-zinc-400">
                <li>
                    <code class="rounded bg-zinc-800 px-1.5 py-0.5">solid-js</code> ^1
                </li>
                <li>
                    <code class="rounded bg-zinc-800 px-1.5 py-0.5">typescript</code> ^5
                </li>
            </ul>
            <h3 class="text-lg font-semibold text-white">Setup</h3>
            <p class="text-zinc-400">
                Wrap your app with{" "}
                <code class="rounded bg-zinc-800 px-1.5 py-0.5">QueryStateAdapter</code>:
            </p>
            <CodeBlock
